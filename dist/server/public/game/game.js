...
function _endState(){
    ...
    endState.classList.add('end-state')

    var points = document.createElement('div');
    points.innerText = 'Points:';

    var nickBox = document.createElement('div');
    nickBox.classList.add('nick-box');

    var nickText = document.createElement('div');
    nickText.innerText = 'Enter nickname: ';
    ...
    nickBox.append(nickText, nickArea, enterNickButton);
    endState.append(points, nickBox);
    return {
        endState:endState,
        points:points,
        nickArea:nickArea,
...
Game.prototype._handleEnterNickButton = function(){
    ...
    var nickname = this._mUi.nickArea.value; 
    var points = 10*this._mResult.player - 7*this._mResult.opponent;
    
    // Send nick and points to server
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "http://localhost:3000/scores", true);
...
Game.prototype._draw = function(){
    ...
    if (this._mDidGameFinished){
        ...
        this._mUi.points.innerText = 'Points: ' + (10*this._mResult.player - 7*this._mResult.opponent);
